...
export class ChatTitle extends Component {
    ...
    componentDidMount = () => {
        ...
        if (chat.last_message && 'owner' in chat.last_message) {
    ...
    render() {
        ...
        if (last_message && 'text' in last_message) {
